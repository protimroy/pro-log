...
<table>
  ...
  <tr>
    <td><div style="background-color:rgba(230, 230, 250, 0.5);">Basis<br>A neural network library written in Python3 and NumPy used as an early framework.</div>Backpropagation through custom layers</td>
  </tr>
